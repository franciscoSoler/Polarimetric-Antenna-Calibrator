...
class Simulator:
    ...
    def run(self, calibr, save_files=True, show_graph=True, mutual_error=False, graphics_to_csv=False):
        visual_comparator = VisualComparator.VisualComparator(save_files, graphics_to_csv)
