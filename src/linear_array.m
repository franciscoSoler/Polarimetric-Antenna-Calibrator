...
% Hace como una transformación, sera para que las cosas no queden tan 
% espaciadas? pierda sensibilidad? no lo se...if dolr is > 0.5 then; choose dol = 0.25 and compute new N (no tengo idea para que hace esto, ya lo sacare en algun momento)
if(dolr <=0.5)
	dol = dolr;
	N = Nr;
else
...
Nrx = 10 * N; % este depende de la separación entre los modulos radiantes, si es mayor a 0.5, triplica o cuadriplica el N!!!
