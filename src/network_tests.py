...
class NetworkTests(unittest.TestCase):
    ...
    def test_the_antenna_should_retrieve_the_correct_rx_s_parameters(self):
        ...
        # circulator
        s2 = np.matrix([[0.0504451320941863, 1.0508948937213702],
                        [1.0324552889581091, 0.9998757319224704]])
        ...
        # circulator
        s2 = np.matrix([[0.062223190694619, 1.0444426083417648],
                        [1.0855382724817848, 0.0661970346133671]])
        ...
        # circulator
        s2 = np.matrix([[0.9388495932799226, 1.0677349122779725],
                        [0.9311591940805913, 0.0596211949125214]])
        ...
        # circulator
        s2 = np.matrix([[0.0040086768451177, 1.0146230756127568],
                        [0.9385528577728693, 0.0849035304525922]])
