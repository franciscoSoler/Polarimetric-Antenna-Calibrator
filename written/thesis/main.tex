...
en el uso de radares y satélites, etc. Este tipo de antenas, al ser comparada con otras (isotrópica, monopolos, etc.), tienen como
...
sin tener que hacer uso de elementos mecánicos. Los cuales poseen ciertas desventajas asociadas tanto desde el punto de vista del 
...
temperatura o el mero envejecimiento de sus componentes. Es deseable tener dichos factores bajo control, para ello se hace uso de
un esquema de calibración interna. De otra forma no sería posible lograr el apuntamiento deseado a un blanco determinado.

Se investiga y presenta el método de calibración interna convencional, sus virtudes y sus defectos, para luego introducir el método
propuesto en este trabajo. El cual busca, sin agregar elementos adicionales al sistema, complementar al método clásico,
compensando sus falencias principales. En primer término, se investigan y presentan las hipótesis necesarias para su aplicación.
