...
Un conjunto de antena es un ejemplo de interferencia, dado que puede ser visto como la suma de N fuentes lineales y coherentes. 
...
tanto AM como FM, para estudios climatológicos y en el uso de satélites y radares para uso marítimo (barcos de guerra de
diversas armadas) y terrestres. La principal ventaja de este tipo de antenas con respecto a otras (isótropa, monopolos), es 
...
que la componen, llevan a que la respuesta final del sistema no sea la esperada. Es deseable tener dichos factores bajo control
y así poder apuntar en la dirección esperada. Para ello se hace uso de un esquema de calibración interna, el cual debe permitir
conocer con una determinada exactitud dicho apuntamiento.

Se investiga y presenta el esquema de calibración interna clásica con sus virtudes y sus defectos. Con dicha información
se introduce un método que lo complemente corrigiendo dichas falencias sin agregar elementos adicionales al sistema. 
...
Quiero agradecer enormemente a toda mi familia, quienes siempre me brindaron incondicionalmente su apoyo, a mis hermanas, Mechi y
Sofi, que siempre me consintieron con brownies en sus tardes de visita y por sobre todo a mis queridos padres. Realmente no
tengo palabras para expresar la enorme gratitud que tengo hacia ellos por nunca perder su fé en mi y por todos sus consejos ante
las dificultades que he tenido a lo largo de todos estos años de estudio. 

También quiero agradecer a todos los conocidos, compañeros y amigos que fui haciendo durante todos estos años facultativos,
que gracias a ellos las largas jornadas de estudio siempre resultaron más amenas. Por último, quiero agradecer a Pablo, quien sin
él este trabajo no hubiese sido posible.
}
\clearpage % Start a new page
...
\begin{acronym}[UML]
	...
	\acro{E-ERS}{ESA - Teledetección Europea (del inglés)}
	...
	\acro{PCC}{Calibración de pulso codificado (del inglés)}
	\acro{PSC}{Divisor/combinador de potencia de RF (del inglés)}
	\acro{REV}{Elemento Rotando el Vector de campo eléctrico (del inglés)}
	...
	\acro{SIR-C}{Radar Espacial de Imágenes - banda C (del inglés)}
	...
	\acro{UCC}{Unidad Central de Control}
