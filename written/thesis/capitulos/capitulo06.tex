...
\begin{figure}[H]
	...
	\caption{Correcciones de la señal transmitida utilizando calibración clásica.}
...
\begin{figure}[H]
	...
	\caption{Correcciones de la señal transmitida utilizando calibración con acoplamientos mutuos.}
	\label{fig:mutualMontecarlo}
\end{figure}

Se puede apreciar que no solo el método utilizando acoplamientos mútuos posee desvíos significativamente menores que el 
...
En esta sección se intenta determinar cuando el método de calibración por acoplamientos mútuos comienza a fallar por no tomar 
