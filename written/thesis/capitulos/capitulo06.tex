...
Por último, a modo de comparación, la figura \ref{fig:sigmaComparation} muestra los desvíos estandar obtenidos utilizando 
ambos calibradores.
...
\begin{figure}[H]
	...
	\caption{Correcciones de la señal transmitida utilizando calibración clásica. (a) ganancia y fase transmitida por módulos
		radiantes. (b) corte horizontal del diagrama transmitido y (c) corte vertical del diagrama transmitido.}
	\label{fig:sigmaComparation}
\end{figure}

\section{Relación entre el desvío de un elemento individual y el diagrama de radiación}
