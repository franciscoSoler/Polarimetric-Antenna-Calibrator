...
\begin{itemize}
	...
	\item \textbf{CrossBuilder:} Esta estrategia construye ecuaciones utilizando la resta de dos lazos que tengan un elemento en 
		...
		\begin{figure}[H]
		 \centering
		 \includegraphics[width=8cm]{gfx/crossBuilder.png}
	...
	\item \textbf{TinyBuilder:} Esta estrategia construye ecuaciones solamente si la cantidad de elementos en alguna dirección, 
        horizontal o vertical, es igual a dos. El modo de operación es, utilizando los cuatro lazos de calibración posibles por
        cada par de elementos que hay en la dirección previamente mencionada, se restan los lazos transmitidos por un elemento
        con los del otro. El resultado es la resta de las dos ramas de transmisión. Para obtener ecuaciones de la resta en 
        recepción el razonamiento es análogo, se deben restar los lazos recibidos de uno con los del otro elemento.
		...
		\begin{figure}[H]
		 \centering
		 \includegraphics[width=9cm]{gfx/tinyBuilder.png}
