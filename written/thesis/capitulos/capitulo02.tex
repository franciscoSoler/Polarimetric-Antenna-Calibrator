...
potencia), sea más angosto, por lo tanto se obtenga una mayor resolución del cuerpo observado. La siguiente figura 
(\ref{fig:directArrayPat}) muestra cómo cambiando la fase de los elementos radiados modifica la dirección del patrón de 
antena.
