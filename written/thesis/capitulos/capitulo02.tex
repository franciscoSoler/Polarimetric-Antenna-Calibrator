...
\chapter{Introducción a las antenas polarimétricas y sus limitaciones} % Chapter title
\label{ch:phasedArray}
\lhead{\emph{Introducción a las antenas polarimétricas y sus limitaciones}}
%----------------------------------------------------------------------------------------
