...
los módulos radiantes (ver figura \ref{fig:compositionAntenna}).
...
El generador de puede emitir distitnos tipos de señales. Ej, cuadrada, chirp, senoidal, triangular, etc. \todo{ahondar mas en este tema}
...
Por último está la antena con sus módulos radiantes, la misma puede tener cualquier geometría deseada. Por ejemplo, en la 
figura \ref{fig:phasedArrayAntenna} se puede observar una distribución circular y una rectangular.
...
los blancos observados, dado que, cada cuerpo responde distinto a ambas polarizaciones.

\begin{figure}[H]
 \centering
 \includegraphics[width=5cm]{gfx/HAndVPolarizations.png}
