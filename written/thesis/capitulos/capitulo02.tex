...
\todo{poner como referencia el libro que tengo en casa}
...
\begin{itemize}
	...
	\item Una red de 2 puertos es simétrica cuado es recíproca ($S_{21} = S_{12}$) y cuando los coeficientes de reflexión son iguales
		($S_{11} = S_{22}$).
