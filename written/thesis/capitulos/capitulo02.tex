...
\todo{corregir imágenes, eliminar la máscara }
\begin{figure}[H]
 \centering
...
tesis se modelará un monopolo como ER, ver figura \ref{fig:radiatingElement}.
\begin{figure}[H]
	\centering
...
\todo{buscar referencias de la ecuación utilizada}
