...
{\textbf{Conjunto de Antena con fase variable (Phased Array):}} \todo{poner referencias en esta definicion} (en inglés: phased array) es un conjunto de antenas en que las fases relativas de las 
...
\begin{comment}
Poner una seccion con lo siguiente, que es un m\'etodo que puede determinar la fase independientemente del estado en que estan los defasadores, 
y que puede calibrar transmisi\'on y recepci\'on de un solo saque, independientemente de que es lo que diga el flaco ese del paper de los 96 elementos radiantes
mencionar en algun lado que en transmision se suele poner un unico valor de ganancia, dado que se desea que los módulos TR trabajen en el punto de compresión, buscar referencia de ganancia en compresión.

Tambien es importante el diagrama de fase, pero en esta tesis vamos a trabajar solamente con el diagrama de ganancia , dado uqe si se modifica uno el otro se modifica congruentemente.
ver si las hipotesis dicen que todo tiene que estar perfectamente adaptado
Poner ejemplo de una rama de parametros S y como se valido en el programa
\end{comment}
