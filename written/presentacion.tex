...
se implementan lazos de calibración internos \todo{Fran: poner referencias de todos los papers de calibración interna en donde se observa esto}. 
Luego se opta por caracterizar todos aquellos componentes que no entran dentro 
de dicho lazo de calibración \todo{Fran: poner referencias de todos los papers en cuestión}. 
...
básico representativo en parámetros S \todo{Fran: pone referencia}
...
\todo{agregar la definición de calibración interna}
...
idea de mediciones por acoplamiento mutuo \todo{(Fran poner REF a los papers)},
...
\todo[inline]{agrega aca Fran los requisitos..que sea LTI, que sea 
representativo desde el punto de vista de parámetros s para RF, etc..}
...
cada componente de la antena. \todo{buscar cuales son estos atributos}
...
\todo{chequear consistencia con objetivos de la tesis}
