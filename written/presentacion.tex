...
aplicaciones aéreas [\ref{ppr:punc-ext1}] y espaciales [\ref{ppr:puncTrgt1}][\ref{ppr:classic8}]. 
Para obtener un buen comportamiento de las mismas para generar diversos 
productos, por ejemplo imágenes satelitales, es necesario que estén 
correctamente calibradas. Esto implica, que las tolerancias de fases y
amplitudes se mantengan y sus valores sean bien conocidas por cada
elemento del arreglo.

Generalmente, este tipo de antenas son calibradas en tierra utilizando fuentes 
externas de campo lejano o cercano [\ref{ppr:mutual1}]. Sin embargo, en aplicaciones aéreas o 
...
distintos métodos de calibración interna.
    ...
    En este conexto, se propone estudiar un método alternativo de calibración, 
el cual aprovecha el acoplamiento mutuo inherente entre los módulos radiantes de
la antena.
...
sus componentes.
	...
	envejecimiento de los componentes [\ref{ppr:mutual1}] o por variaciones de temperaturas se
...
\end{itemize}
	...
	\begin{enumerate}[ {[}1{]} ]
        ...
        \item \label{ide} https://www.jetbrains.com/pycharm/
        \item \label{tareas} https://trello.com/
        \item \label{versionado} https://github.com/
	\end{enumerate}
...
\personalData{Fecha de nacimiento: 04/10/1989}{Edad: 25 años}
